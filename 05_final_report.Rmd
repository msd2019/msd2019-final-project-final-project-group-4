...
```{r predict accuracy bar graphs, Warning = FALSE, Message = FALSE, fig.align="center", echo = FALSE}
...
```{r bitcoin predictive accuracy bar chart, Warning = FALSE, Message = FALSE, fig.align="center", echo = FALSE}
