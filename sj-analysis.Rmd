...
```{r predict accuracy bar graphs, Warning = FALSE, Message = FALSE, fig.align="center"}
...
\begin{tabular}{lllll}
\hline
              & Epinions & Slashdot & Wikipedia & New Wikipedia \\ \hline
...
\end{tabular}
\caption{Predictive accuracy when training on the "row" dataset and evaluating the prediction on the "column" dataset with added New Wikipedia dataset.}
\label{tab:my-table}
\end{table}
...
```{r bitcoin predictive accuracy bar chart, Warning = FALSE, Message = FALSE, fig.align="center"}
...
```{r average embeddedness, Warning = FALSE, Message = FALSE}
